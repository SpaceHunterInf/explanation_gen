...
def get_args():
    ...
    parser.add_argument("--model_checkpoint", type=str, default="ynie/roberta-large-snli_mnli_fever_anli_R1_R2_R3-nli", help="Path, url or short name of the model")
    parser.add_argument("--saving_dir", type=str, default="roberta-nli", help="Path for saving")
